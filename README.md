...
express built in middleware, such as express.json().
express Router to partition our application.

- [ ] Describe Middleware?
     a function that gets passed through the stack and could alter data through the stack and passes it down through next()

- [ ] Describe a Resource?
     a api that acts as a middleware, such as helmet
